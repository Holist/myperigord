...
puts 'Starts Product Creation'
  ...
  po7 = Product.create(name: "Pruneaux", description: "Des pruneaux Bio ou conventionnels", photo: "http://gourmetpedia.org/media/upload/ingredient/693.jpg", price_cents: 380, productor: p5)
  po8 = Product.create(name: "Pruneaux à l'eau de vie", description: "Pruneaux" , photo: "https://flaveur.ch/alcool/1708-large_default/pruneaux-%C3%A0-l-eau-de-vie-15kg.jpg", price_cents: 534, productor: p5)
  po9 = Product.create(name: "Confiture de pruneaux" , description: "Confiture Bio", photo: "http://www.dessertsetconfitures.com/var/dessert/storage/images/media/images/confiture-de-prune2/12348-1-fre-FR/Confiture-de-prune_recette.jpg", price_cents: 456, productor: p5)
