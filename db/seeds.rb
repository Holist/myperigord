...
puts 'Starts Producer Creation'
  p1 = Productor.create(
    ...
    compagny: "Brasserie du Sud Ouest", description: "Vente de Bières", website:"https://brasseriedusudouest.com/", quote: "La bière par excellence!",productor_banner: "http://2.bp.blogspot.com/-4rfdwREMcRk/T5A0wSt_USI/AAAAAAAAr-s/08MGN75I8ys/s640/Cuves+Brasserie+Pe%CC%81lican.jpg", avatar: "https://images.sudouest.fr/2017/12/16/5a3486fc66a4bd731e62c79d/widescreen/1000x500/yoann-delibie-et-jonathan-krumhorn-proposent-de-la-biere-artisanale.jpg")
  ...
  p5 = Productor.create(email: "berna@wanadoo.fr", password: "azerty", first_name: "Marie-line", last_name:"Berna", address: "Domaine de Roudigou 47 500 Cuzorn", phone:"05 53 75 16 10", compagny: "Le Domaine de Roudigou", description: "Gîte et Vente de Pruneaux", website:"http://www.domainederoudigou.com/", quote: "Savourez l'authenticité !", productor_banner: "https://scontent-frt3-2.xx.fbcdn.net/v/t1.0-9/946869_656827474343403_898239896_n.jpg?_nc_cat=0&oh=4414f3fca0666f381cc22ad168378e30&oe=5C19AB80", avatar: "https://scontent-frt3-2.xx.fbcdn.net/v/t1.0-9/39443038_2683104415049022_1508616295036223488_n.jpg?_nc_cat=0&oh=3e76842b0171d1ee2fbb4a0a97966a27&oe=5C1A9920")
puts 'End'

puts 'Starts Product Creation'
  po1 = Product.create!(name: "La Wanted", description: "A mi-chemin entre culture américaine et nippone, la golden ale n’en oublie pas moins ses racines périgourdines et vous fera voyager avec ses saveurs d’agrumes, de fruits jaune et même de noix de coco !", photo: "https://i0.wp.com/brasseriedusudouest.com/wp-content/uploads/2017/12/La_Wanted_Golden_Ale_boutique.png?resize=300%2C300&ssl=1", price_cents: 235, productor: p1)
  po2 = Product.create(name: "Hop Blanche", description: "La Hop Blanche est une bière de fermentation haute.Bière estivale par excellence. Sa faible amertume et sa légèreté vous laisserons découvrir sa fraicheur aromatique aux notes de fruits jaunes.", photo: "https://i1.wp.com/brasseriedusudouest.com/wp-content/uploads/2018/06/Hop_blanche.png?resize=300%2C300&ssl=1", price_cents: 245, productor: p1)
  po3 = Product.create(name: "Hop Pale Ale", description: "Cette Pale ale single HOP, est une bière blonde de haute fermentation facile à boire.Brassée le plus simplement avec 3 malts et un seul houblon cette bière n’en demeure pas moins unique et saura combler vos moindres envies maltées !", photo: "https://i2.wp.com/brasseriedusudouest.com/wp-content/uploads/2018/06/Hop_pale_ale_boutique.png?resize=300%2C300&ssl=1", price_cents: 345, productor: p1)
  po4 = Product.create(name: "Vin Verdots Bergerac", description: "Sélection des cuvées les plus harmonieuses, aux tanins souples et soyeux, issu de Merlot, Cabernet Sauvignon et de Malbec." , photo: "http://www.vin-verdots-bergerac.com/wp-content/uploads/2015/02/clos-rouge-400px.jpg", price_cents: 1657, productor: p4)
  po5 = Product.create(name: "Tours Monbazillac", description: "Argilo-siliceux sur marne et calcaire de Monbazillac. Ce sol permet de produire une très grande concentration apportée entre autres par le Botrytis Cinerea et une belle fraîcheur qui donne l’originalité des grands Monbazillac.", photo: "http://www.vin-verdots-bergerac.com/wp-content/uploads/2015/02/tours-monbazillac-400px.jpg", price_cents: 1567, productor: p4)
  po6 = Product.create(name: "Vin Blanc Sec" , description: "Assemblage de 4 terroirs très différents qui en font son originalité, à savoir-sablo-limono-argileux sur molasse du Fronsadais qui donne toute la puissance aromatique,-argilo-calcaire sur calcaire de type ondes qui donne au vin toute sa puissance en bouche,-limoneux-sableux de plateau riche en fer qui donne la structure,-limoneux-argileux-graveleux de pente sur calcaire de Castillon qui donne une belle acidité et de la longueur en bouche." , photo: "http://www.vin-verdots-bergerac.com/wp-content/uploads/2015/02/le-vin-selon-blanc-sec-400px.jpg", price_cents: 1245, productor: p4)
  po7 = Product.create(name: "Pruneaux", description: "loremLorem ipsum dolor sit amet, consectetur adipisicing elit. Officia reprehenderit dicta neque et hic culpa non vitae necessitatibus quo, obcaecati, molestias, perferendis atque cupiditate quos molestiae voluptatem? Est labore, dolores.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus sunt praesentium beatae sapiente magni explicabo. Alias, similique dolore odit aperiam a mollitia dignissimos placeat voluptas hic perferendis dolor exercitationem dicta?", photo: "http://gourmetpedia.org/media/upload/ingredient/693.jpg", price_cents: 380, productor: p5)
  po8 = Product.create(name: "Pruneaux à l'eau de vie", description: "loremLorem ipsum dolor sit amet, consectetur adipisicing elit. Officia reprehenderit dicta neque et hic culpa non vitae necessitatibus quo, obcaecati, molestias, perferendis atque cupiditate quos molestiae voluptatem? Est labore, dolores.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus sunt praesentium beatae sapiente magni explicabo. Alias, similique dolore odit aperiam a mollitia dignissimos placeat voluptas hic perferendis dolor exercitationem dicta?" , photo: "https://flaveur.ch/alcool/1708-large_default/pruneaux-%C3%A0-l-eau-de-vie-15kg.jpg", price_cents: 534, productor: p5)
  po9 = Product.create(name: "Confiture de pruneaux" , description: "loremLorem ipsum dolor sit amet, consectetur adipisicing elit. Officia reprehenderit dicta neque et hic culpa non vitae necessitatibus quo, obcaecati, molestias, perferendis atque cupiditate quos molestiae voluptatem? Est labore, dolores.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus sunt praesentium beatae sapiente magni explicabo. Alias, similique dolore odit aperiam a mollitia dignissimos placeat voluptas hic perferendis dolor exercitationem dicta?", photo: "http://www.dessertsetconfitures.com/var/dessert/storage/images/media/images/confiture-de-prune2/12348-1-fre-FR/Confiture-de-prune_recette.jpg", price_cents: 456, productor: p5)
  po10 = Product.create(name: "Sphére ChocoOr", description: "Delicieuse sphère finalement chocolatée à feuilles d'or", photo: "https://lechocolatdanstousnosetats.com/wp-content/uploads/2016/12/IMG_0091-1024x1024.jpg", price_cents: 1850, productor: p3)
  po11 = Product.create(name: "Safran", description: "Safran pure", photo: "http://www.lordesanges.com/wp-content/uploads/2016/05/safran-principale.jpg", price_cents: 1990, productor: p2)
  po12 = Product.create(name: "Truffes Extra Brossés", description: "Consommée depuis l’Antiquité, il a fallu attendre Brillat-Savarin pour que la truffe du Périgord obtienne ses lettres de noblesse en cuisine. La Tuber Melanosporum, dite du Périgord, ne peut laisser indifférent ; son parfum puissant est incomparable, son goût unique. Ainsi elle agrémente tout ce qui entre en contact avec elle.", photo: "http://www.lordesanges.com/wp-content/uploads/2015/11/slide-accueil-0001.jpg", price_cents: 1580, productor: p2)
puts 'End'
...
puts 'Starts OrderProducts Creation'
  op1 = OrderProduct.create(product: po8, order: o1, quantity: 2, price_cents: 534)
  op2 = OrderProduct.create(product: po1, order: o1, quantity: 1, price_cents: 235)
  op3 = OrderProduct.create(product: po5, order: o1, quantity: 3, price_cents: 1567)
  op4 = OrderProduct.create(product: po6, order: o1, quantity: 1, price_cents: 1245)

  op4 = OrderProduct.create(product: po2, order: o2, quantity: 1, price_cents: 245)
  op4 = OrderProduct.create(product: po4, order: o2, quantity: 4, price_cents: 1657)
  op4 = OrderProduct.create(product: po10, order: o2, quantity: 1, price_cents: 1850)

  op4 = OrderProduct.create(product: po3, order: o3, quantity: 2, price_cents: 345)
  op4 = OrderProduct.create(product: po7, order: o3, quantity: 1, price_cents: 380)
  op4 = OrderProduct.create(product: po11, order: o3, quantity: 1, price_cents: 1990)
puts 'End'

puts 'Update Amount Order'
  o1.amount_update
  o2.amount_update
  o3.amount_update
puts "End"
